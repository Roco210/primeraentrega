class ProductManager {
    ...
    addProduct(title, description, price, thumbmail, code, stock) {
        if (!title || !description || !price || !thumbmail || !stock || !code) { //uso la combinacion de ternario OR || y el not ! para determinar los elemnetos vacios
            ...
            if (checkCode) {
                ...
                let id //se define la variable id sin valor, ya que se asigna en la linea siguiente con el IF
